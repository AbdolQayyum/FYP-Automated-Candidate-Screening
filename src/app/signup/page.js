    ...
    <div className="box3-animate grid w-4/5 md:w-[60%] h-auto grid-cols-1 md:grid-cols-2 bg-gray-900 rounded-full">
      ...
      <div className="bg-gray-100 text-gray-900 flex flex-col justify-center p-8">
        ...
        <form className="mt-6">
          ...
          {/* Signup Button */}
          <Button onClick={(Onsignup) => router.push('/login')} type='submit' className="custom-button w-full p-2 rounded-xl border border-black bg-gray-900 text-gray-100 hover:bg-gray-700" disabled={buttonDisabled}>

            {buttonDisabled ? "No SignUp" : "SignUp"}
          </Button>
          <p className="text-xs mt-4 mb-2 text-center">Already have an account? <a href="/login" className="text-blue-600">Login</a></p>
